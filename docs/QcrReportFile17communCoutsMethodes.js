...
//<![CDATA[
	...
	function doRemplirPageCoutsMethodes() {
		...
		var lsStr= "<tr><td>Class and method</td><td>Annotations</td><td>Cost</td><td>Return class</td><td>Return class depth</td><td>Nb of fields in return class</td></tr>";
		lsStrTout+=lsStr;
		lesdetailsclasses.forEach(leItemDetail => {
			var lsStrDetails = "";
	                lsStrDetails+= "<tr><td>"+leItemDetail.methode+"</td><td>"+leItemDetail.annotation+"</td><td align='right'>"+leItemDetail.couttotal+"</td><td>"+leItemDetail.classe_retour+"</td><td>"+leItemDetail.profondeurinclude+"</td><td>"+leItemDetail.nbchampsclasse+"</td></tr>";
