...
//<![CDATA[
	...
	function doRemplirPageCoutsMethodes() {
		...
		var lsStr= "<tr><td>Class and method</td><td>Annotations</td><td>Cost</td></tr>";
		lsStrTout+=lsStr;
		lesdetailsclasses.forEach(leItemDetail => {
			var lsStrDetails = "";
	                lsStrDetails+= "<tr><td>"+leItemDetail.methode+"</td><td>"+leItemDetail.annotation+"</td><td align='right'>"+leItemDetail.couttotal+"</td></tr>";
